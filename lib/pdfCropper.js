 ...
 */
export async function renderPageToCanvas(pdfBytes, pageIndex, canvas, containerWidth, maxHeight) {
  ...
  const displayWidth  = containerWidth || canvas.parentElement?.offsetWidth || 560
  const scaleByWidth  = displayWidth / viewport.width
